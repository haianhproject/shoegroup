      ...
      <div class="custom-modal-box fade-in-scale" style="max-width:640px;">
        ...
        <div class="p-4" style="max-height:65vh;overflow:auto;">
          ...
          <div class="grid grid-cols-12 gap-3">
            ...
            <div class="md:col-span-6"><label class="block text-sm font-medium text-sm font-medium">Giá áp dụng / phần trăm giảm</label><input v-model.number="variantDiscountModal.data.value" type="number" class="sg-input rounded-2" placeholder="Nhập giá bán mới (VNĐ) hoặc %"><small class="text-gray-600" style="font-size:0.72rem;">Cố định: giá bán mới của màu · Phần trăm: mức giảm từ giá gốc</small></div>
